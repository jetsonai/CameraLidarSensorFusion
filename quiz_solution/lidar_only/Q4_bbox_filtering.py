...
# 1번, 2번, 3번, 4번 조건을 모두 만족하는 클러스터 필터링 및 바운딩 박스 생성
bboxes_1234 = []
...
o3d.visualization.draw_geometries([final_point] + bboxes_1234, 
                                  window_name="Clusters filtered by Condition 1, 2, 3, 4")
